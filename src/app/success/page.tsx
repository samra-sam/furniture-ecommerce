...
// Function to generate a random alphanumeric order number
...
const SuccessPage = () => {
  ...
  useEffect(() => {
    const orderNum = searchParams.get("orderNumber") || generateRandomOrderNumber();
    setOrderNumber(orderNum);
  }, [searchParams]);

  return (
    <div className=" mt-12 py-10 md:py-20 bg-gradient-to-br flex items-center justify-center p-4">
      <motion.div
